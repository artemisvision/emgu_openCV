...
namespace Emgu.CV.UI
{
   ...
   public partial class ImageBox : PanAndZoomPictureBox
   {
      ...
      public event EventHandler OnOperationListChanged;
       ...
       public void InsertOperation(int op_index, Operation operation)
      {
       ...
       public void InactivateOperation(int op_index)
       {
           _operationLists[op_index].Active=false;
           ImageProperty panel = ImagePropertyPanel;
           if (panel != null) panel.SetOperations(_operationLists);
           Image = Image;
       }
      ...
      public Operation[] PeekOperations()
      {
          Operation[] oplist = _operationLists.ToArray();
          return oplist;
      }
      ...
      public ToolStripMenuItem[] BuildOperationTree(IEnumerable<KeyValuePair<string, MethodInfo>> catelogMiPairList)
      {
